...
import { Container, Title, Row, Label, Value, StyledInput, StyledLink, CheckboxGroup, CheckboxLabel, Email, Tg, Subscription, StyledSpan, StyledCheckbox } from './styles/SettingsPage.styles';
